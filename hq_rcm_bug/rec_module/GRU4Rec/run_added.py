...
import numpy as np
import pandas as pd
import gru4rec_added
import evaluation_added
import baselines
import matplotlib.pyplot as plt

PATH_TO_TRAIN = '../report_labels_train_eclipse'
PATH_TO_TEST = '../report_labels_test_eclipse'
...
if __name__ == '__main__':
    ...
    #top=11
    gru = gru4rec_added.GRU4Rec(n_epochs=10,loss='top1', final_act='tanh', hidden_act='relu', layers=[512], batch_size=32, dropout_p_hidden=0.5, learning_rate=0.01, momentum=0.0, embedding=100,time_sort=False)
    gru.fit(data)
    ...
    #mrr_mf=[]
    for i in top:
        res_gru = evaluation_added.evaluate_sessions_batch(gru, valid, None,cut_off=i+1)
